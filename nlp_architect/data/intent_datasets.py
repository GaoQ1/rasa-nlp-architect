...
class SNIPS(IntentDataset):
    ...
    # train_files = [
    #     'intel_nlu_train/request_search.json',
    #     'intel_nlu_train/request_management.json',
    #     'intel_nlu_train/inform_time.json',
    #     'intel_nlu_train/inform_package.json',
    #     'intel_nlu_train/inform_item.json',
    #     'intel_nlu_train/greet.json'
    # ]
    # test_files = [
    #     'intel_nlu_test/request_search.json',
    #     'intel_nlu_test/request_management.json',
    #     'intel_nlu_test/inform_time.json',
    #     'intel_nlu_test/inform_package.json',
    #     'intel_nlu_test/inform_item.json',
    #     'intel_nlu_test/greet.json'
    # ]
